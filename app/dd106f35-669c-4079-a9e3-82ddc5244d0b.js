var fn_addin = function (l, d, t) {
  ...
  (i.styles = i.styles || {}),
      ...
      (i.info = { addin: "dd106f35-669c-4079-a9e3-82ddc5244d0b", id: "settings_quotes", dependencies: ["settings"], commands: ["settings.panels.quotes"] }),
      l.console.log(l.elapsed() + ": " + i.info.id + " started"),
      (i.templates = i.templates || {}),
      (i.templates.custom = Handlebars.template({
          compiler: [6, ">= 2.0.0-beta.1"],
          main: function (t, e, s, i) {
      ...
      (i.templates.favorites = Handlebars.template({
          compiler: [6, ">= 2.0.0-beta.1"],
          main: function (t, e, s, i) {
      ...
      (i.templates.history = Handlebars.template({
          compiler: [6, ">= 2.0.0-beta.1"],
          main: function (t, e, s, i) {
      ...
      (i.templates.item = Handlebars.template({
          1: function (t, e, s, i) {
              var n,
                  o = e.helperMissing,
                  a = "function",
              ...
              return (
                  ...
                  l(typeof (n = null != (n = e.isFavClass || (null != t ? t.isFavClass : t)) ? n : o) == a ? n.call(t, { name: "isFavClass", hash: {}, data: i }) : n) +
                  '" title="' +
                  l(typeof (n = null != (n = e.isFavTitle || (null != t ? t.isFavTitle : t)) ? n : o) == a ? n.call(t, { name: "isFavTitle", hash: {}, data: i }) : n) +
          ...
          main: function (t, e, s, i) {
              ...
              return (
                  ...
                  d(typeof (o = null != (o = e.body || (null != t ? t.body : t)) ? o : a) == l ? o.call(t, { name: "body", hash: {}, data: i }) : o) +
                  '<span class="quote-mark">&rdquo;</span></span>\x3c!--\n\t\t--\x3e<span class="cquote-source" data-test="source">' +
                  d(typeof (o = null != (o = e.source || (null != t ? t.source : t)) ? o : a) == l ? o.call(t, { name: "source", hash: {}, data: i }) : o) +
                  '</span>\n\t</div>\n\n\t<span class="controls">\x3c!--\n\t\t--\x3e<span class="control control-select u--clickable" title="' +
                  d(typeof (o = null != (o = e.labelSelect || (null != t ? t.labelSelect : t)) ? o : a) == l ? o.call(t, { name: "labelSelect", hash: {}, data: i }) : o) +
                  ...
                  d(typeof (o = null != (o = e.labelSyncError || (null != t ? t.labelSyncError : t)) ? o : a) == l ? o.call(t, { name: "labelSyncError", hash: {}, data: i }) : o) +
                  '">!</i></span>\x3c!--\n' +
                  (null != (n = e.if.call(t, null != t ? t.showFavControl : t, { name: "if", hash: {}, fn: this.program(1, i, 0), inverse: this.noop, data: i })) ? n : "") +
                  (null != (n = e.if.call(t, null != t ? t.onCustomSubnav : t, { name: "if", hash: {}, fn: this.program(3, i, 0), inverse: this.noop, data: i })) ? n : "") +
                  ...
                  d(typeof (o = null != (o = e.inputLengthMaxHtml || (null != t ? t.inputLengthMaxHtml : t)) ? o : a) == l ? o.call(t, { name: "inputLengthMaxHtml", hash: {}, data: i }) : o) +
                  '" data-test="body-edit">' +
                  d(typeof (o = null != (o = e.body || (null != t ? t.body : t)) ? o : a) == l ? o.call(t, { name: "body", hash: {}, data: i }) : o) +
                  '</textarea>\x3c!--\n\t--\x3e<input type="text" class="list-edit-source input input-source" value="' +
                  d(typeof (o = null != (o = e.source || (null != t ? t.source : t)) ? o : a) == l ? o.call(t, { name: "source", hash: {}, data: i }) : o) +
                  '" maxlength="' +
                  d(typeof (o = null != (o = e.inputLengthMaxHtmlSource || (null != t ? t.inputLengthMaxHtmlSource : t)) ? o : a) == l ? o.call(t, { name: "inputLengthMaxHtmlSource", hash: {}, data: i }) : o) +
      ...
      (i.templates.main = Handlebars.template({
          ...
          main: function (t, e, s, i) {
              ...
              return (
                  ...
                  l(typeof (n = null != (n = e.title || (null != t ? t.title : t)) ? n : o) == a ? n.call(t, { name: "title", hash: {}, data: i }) : n) +
                  '</h3>\n\t<p class="description">' +
                  l(typeof (n = null != (n = e.description || (null != t ? t.description : t)) ? n : o) == a ? n.call(t, { name: "description", hash: {}, data: i }) : n) +
                  ...
                  l(typeof (n = null != (n = e.feedMomentumClass || (null != t ? t.feedMomentumClass : t)) ? n : o) == a ? n.call(t, { name: "feedMomentumClass", hash: {}, data: i }) : n) +
                  ...
                  l(typeof (n = null != (n = e.feedCustomClass || (null != t ? t.feedCustomClass : t)) ? n : o) == a ? n.call(t, { name: "feedCustomClass", hash: {}, data: i }) : n) +
                  '" id="feed-custom-slider" data-test="feed-custom-slider">\n\t\t\t\t\t<span class="toggle-slider"><svg class="toggle-switch" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><circle cx="50" cy="50" r="50"/></svg></span>\n\t\t\t\t\t<span class="setting-name">' +
                  l(typeof (n = null != (n = e.labelCustom || (null != t ? t.labelCustom : t)) ? n : o) == a ? n.call(t, { name: "labelCustom", hash: {}, data: i }) : n) +
                  ...
                  l(typeof (n = null != (n = e.labelCustom || (null != t ? t.labelCustom : t)) ? n : o) == a ? n.call(t, { name: "labelCustom", hash: {}, data: i }) : n) +
                  '</h4>\x3c!--\n\t\t--\x3e<h4 class="favorites" data-test="subnav-favs">Favorites</h4>\x3c!--\n\t\t--\x3e<h4 class="history" data-test="subnav-history">History</h4>\n\t</div>\n\t<button class="button list-add-button" data-test="button-add">' +
                  l(typeof (n = null != (n = e.labelAdd || (null != t ? t.labelAdd : t)) ? n : o) == a ? n.call(t, { name: "labelAdd", hash: {}, data: i }) : n) +
                  ...
                  l(typeof (n = null != (n = e.inputLengthMaxHtml || (null != t ? t.inputLengthMaxHtml : t)) ? n : o) == a ? n.call(t, { name: "inputLengthMaxHtml", hash: {}, data: i }) : n) +
                  '" data-test="textarea-body"></textarea>\x3c!--\n\t\t--\x3e<input type="text" class="list-add-source input input-source" maxlength="' +
                  l(typeof (n = null != (n = e.inputLengthMaxHtmlSource || (null != t ? t.inputLengthMaxHtmlSource : t)) ? n : o) == a ? n.call(t, { name: "inputLengthMaxHtmlSource", hash: {}, data: i }) : n) +
                  ...
                  l(typeof (n = null != (n = e.labelSyncError || (null != t ? t.labelSyncError : t)) ? n : o) == a ? n.call(t, { name: "labelSyncError", hash: {}, data: i }) : n) +
      ...
      (i.collect.Quotes = Backbone.Collection.extend({
          ...
          comparator: function (t, e) {
              var s = this.sortAttribute || "sort_order",
                  i = t.get(s),
                  n = e.get(s);
              return i == n ? 0 : i < n ? (this.reverse_sort ? 1 : -1) : n < i ? (this.reverse_sort ? -1 : 1) : void 0;
          },
      })),
      (i.models.Quote = Backbone.Model.extend({
          defaults: function () {
          ...
          setActive: function (e, s) {
              ...
              this.get("is_custom") ? (i.custom_quote_id = n) : (i.quote_id = n),
                  d
                      ...
                      .done(function (t) {
                          t && t.success ? (l.trigger("sync:download", "quote"), e(this)) : s(this);
                      })
                      .fail(function () {
                          s(this);
                      });
      ...
      (i.models.QuoteSettingsManager = Backbone.Model.extend({
          ...
          onQuoteFavorited: function (t) {
              if (this.favorites) {
                  ...
                  e ? (e.set({ is_favorite: t.is_favorite, last_updated: l.date().toISOString() }), this.favorites.sort()) : this.favorites.fetch();
              }
              if (this.history) {
                  var s = this.history.findWhere({ _id: t.id });
                  s ? (s.set({ is_favorite: t.is_favorite, last_updated: l.date().toISOString() }), this.history.sort()) : this.history.fetch();
              }
          },
          onActiveQuoteChanged: function (t) {
              if (this.lastActiveQuote !== t && this.history) {
                  var e = this.history.at(0);
                  if (e && e.get("_id") !== t) {
                      var s = this.history.findWhere({ _id: t });
                      if ((!s && this.collection && (s = this.collection.findWhere({ id: t })), !s && this.favorites && (s = this.favorites.findWhere({ id: t })), s)) {
                          var i = s.clone();
                          i.has("_id") || i.set("id", t), i.set("sort_order", i.get("sort_order") + "-" + l.now()), (i.prepend = !0), this.history.add(i), this.history.sort(), (this.lastActiveQuote = t);
                      }
                  }
              }
          },
          CustomQuotes: function () {
              return (
                  this.collection ||
                      ((this.collection = new i.collect.Quotes()),
          ...
          Favorites: function () {
              return (
                  this.favorites || ((this.favorites = new i.collect.Quotes()), (this.favorites.url = l.globals.urlRoot + "quotes/favorites"), (this.favorites.sortAttribute = "last_updated"), (this.favorites.reverse_sort = !1)),
                  this.favorites
              );
          },
          History: function () {
              ...
              return (
                  this.history ||
                      ((this.history = new i.collect.Quotes()),
          ...
          onCollectionRemove: function () {
              l.trigger("sync:download", "quote"), this.customEmpty() && this.collection.trigger("user-change"), this.history && (this.history.loadedOnce = !1), this.favorites && (this.favorites.loadedOnce = !1);
          },
          toggleFavorite: function (e, s) {
              ...
              try {
                  d.ajax({ type: "POST", contentType: "application/json", data: JSON.stringify(a), url: t })
                      .done(function (t) {
                          t && t.success && (e.set({ is_favorite: n }), l.trigger("sync:download", "quote"), l.trigger("quote:favorite", { id: a.active_uuid, is_favorite: a.is_favorite }));
                      })
                      .fail(function () {
                          s && s();
                      });
          ...
          toggleFeedMomentum: function () {
              this.plusUser && (this.settings.toggle(this.feedMomentumName), l.settingsUtils.sendEventToggleFeed(this.panelTitle, "Toggle Momentum", this.settings.get(this.feedMomentumName)));
          },
          toggleFeedCustom: function () {
              this.plusUser ? (this.settings.toggle(this.feedCustomName), l.settingsUtils.sendEventToggleFeed(this.panelTitle, "Toggle Custom", this.settings.get(this.feedCustomName))) : this.showPlusUpsellNotif();
          },
          showPlusUpsellNotif: function () {
              var t = { targetRegion: "settings", sourceEvent: "customQuotes-toggleFeed", buttonText: "Learn more", title: this.labelCustom, description: "Activate your favorite quotes or add your own" };
              l.commandManager.execute("upsell.message", t);
          },
      ...
      (i.views.Custom = Backbone.View.extend({
          template: i.templates.custom,
          events: { "click .empty-add-shortcut": "handleEmptyAddShortcutClick" },
          initialize: function (t) {
              (this.main = t.main),
                  (this.subViews = []),
                  l.quoteSettingsManager || (l.quoteSettingsManager = new i.models.QuoteSettingsManager()),
          ...
          addOne: function (t, e) {
              var s = new i.views.CustomQuote({ model: t, main: this.main, subnav: "custom" });
              l.settingsUtils.subnavAddOne(this, s, this.$quoteList, !0, e);
          },
      ...
      (i.views.Favorites = Backbone.View.extend({
          template: i.templates.favorites,
          initialize: function (t) {
              (this.main = t.main),
                  (this.subViews = []),
                  l.quoteSettingsManager || (l.quoteSettingsManager = new i.models.QuoteSettingsManager()),
          ...
          addOne: function (t) {
              if (t.get("is_favorite")) {
                  var e = new i.views.CustomQuote({ model: t, main: this.main, subnav: "favorites" });
                  l.settingsUtils.subnavAddOne(this, e, this.$quoteList, !0, !1);
              }
          },
          onCollectionAdd: function (t) {
              this.addOne(t);
      ...
      (i.views.History = Backbone.View.extend({
          template: i.templates.history,
          ...
          addAll: function () {
              l.settingsUtils.subnavAddAll(this, !1, this.$quoteList, this.main.syncActiveItem.bind(this.main), l.settingsUtils.subnavHistoryUpdateLoadMore.bind(this));
          },
          addOne: function (t) {
              var e = new i.views.CustomQuote({ model: t, main: this.main, subnav: "history" });
      ...
      (i.views.CustomQuote = Backbone.View.extend({
          attributes: { class: "content-item quote-item", "data-test": "item" },
          tagName: "li",
          template: i.templates.item,
          events: {
          ...
          render: function () {
              (this.isFavorite = this.model.get("is_favorite")), (this.quoteId = this.model.get("_id") || this.model.id);
              var t = {
              ...
              return this.$el.html(this.template(t)), this.setViewVars(), this.$el.attr("data-quote-id", this.quoteId), this.updateTooltip(), this;
          },
          setViewVars: function () {
              (this.$deleteGroup = this.$(".delete-group")), (this.$listEditForm = this.$(".list-edit-form")), (this.$listEditBody = this.$(".list-edit-body")), (this.$listEditSource = this.$(".list-edit-source"));
          },
          ...
          handleClickSetActive: function () {
              this.main.plusUser ? (this.setQuoteActive(), l.sendEvent(this.manager.panelTitle, "Set Active")) : this.manager.showPlusUpsellNotif();
          },
          setQuoteActive: function () {
              ...
              l.models.quoteManager.setActiveInProgress ||
                  ...
                  this.model.setActive(
                      function () {
                          t.$el.removeClass("loading"), (t.setActiveInProgress = !1), (l.models.quoteManager.setActiveInProgress = !1), t.model.get("is_custom") && t.main.collection.trigger("user-change");
                      },
                      function () {
                          t.$el.removeClass("loading").addClass("failed"), (t.setActiveInProgress = !1), (l.models.quoteManager.setActiveInProgress = !1);
                      }
                  ));
          },
          handleClickFavorite: function () {
              l.sendEvent(this.manager.panelTitle, "Favorite", this.model.get("is_favorite") ? "unfavorite" : "favorite"), l.quoteSettingsManager.toggleFavorite(this.model);
          },
          handleClickEdit: function () {
              this.$listEditForm.removeClass("loading failed"), l.settingsUtils.changeToEditMode(this, this.$listEditBody), this.updateTooltip();
          },
          ...
          deleteItem: function () {
              ...
              this.$deleteGroup.hasClass("loading") ||
                  ...
                  l.sendEvent(this.manager.panelTitle, "Delete"));
          },
          ...
          updateItem: function (t, e) {
              ...
              this.model.save(t, {
                  wait: !0,
                  success: function () {
                      e.removeClass("loading"), l.trigger("sync:download", "quote"), l.settingsUtils.getOutOfEditMode(s), s.main.collection.trigger("user-change");
                  },
                  error: function () {
                      e.removeClass("loading").addClass("failed");
                  },
              }),
                  l.sendEvent(this.manager.panelTitle, "Edit");
          },
          handleClickCancel: function (t) {
              t.preventDefault(), this.abortEdit();
          },
          abortEdit: function () {
              this.$listEditBody.val(this.model.get("body")), this.$listEditSource.val(this.model.get("source")), l.settingsUtils.getOutOfEditMode(this);
          },
          destroy: function () {
  ...
  return (
      (i.views.Main = e.views.SettingsPanel.extend({
          attributes: { id: "settings-quotes", class: "settings-view settings-content settings-quotes settings-online", "data-test": "settings-quotes" },
          deletingFinalItem: !1,
          ...
          initialize: function (t) {
              t && (this.subnav = t.subnav),
                  ...
                  l.sendEvent(this.manager.panelTitle, "Panel Opened");
          },
          render: function () {
              var t = {
          ...
          selectSubnav: function (t, e, s) {
              e.stopPropagation(), this.subnav !== t ? (this.hideAddForm(), this.resetAdd(), s(), l.sendEvent(this.manager.panelTitle, "Select Subnav", t)) : l.utils.toggleClassTwice(d(e.delegatedTarget), "active");
          },
          renderCustom: function () {
              this.customView || (this.customView = new i.views.Custom({ el: this.$customList, main: this })), l.settingsUtils.renderSubnav(this, this.customView, "custom");
          },
          renderFavorites: function () {
              this.favoritesView || (this.favoritesView = new i.views.Favorites({ el: this.$favoritesList, main: this })), l.settingsUtils.renderSubnav(this, this.favoritesView, "favorites");
          },
          renderHistory: function () {
              this.historyView || (this.historyView = new i.views.History({ el: this.$historyList, main: this })), l.settingsUtils.renderSubnav(this, this.historyView, "history");
          },
          ...
          syncActiveItem: function () {
              if (l.models.customization.get("quoteVisible")) {
                  var t = l.models.quoteManager.getActiveItem().get("_id");
                  this.syncActiveItemHelper(this.$customList, t), this.syncActiveItemHelper(this.$favoritesList, t), this.syncActiveItemHelper(this.$historyList, t);
              }
          },
          ...
          toggleAddForm: function () {
              "custom" !== this.subnav && this.renderCustom(),
                  ...
                  this.$addForm.is(":visible") ? this.hideAddForm() : (this.$addButton.hide(), this.$addForm.css("display", "block"), this.$addBody.trigger("focus"));
          },
          ...
          createItem: function (t, e) {
              ...
              this.collection.create(t, {
                  ...
                  l.sendEvent(this.manager.panelTitle, "Add");
          },
          ...
          updateSubmitButton: function (t, e, s) {
              var i = 0 === e || s < 0;
              t.find(".submit").prop("disabled", i).toggleClass("disabled", i);
          },
          processForm: function (t, e, s) {
              if ((t && t.preventDefault(), !e.find(".submit").prop("disabled") && !e.hasClass("loading"))) {
                  var i = e.hasClass("list-edit-form"),
                      n = this.validateForm(e, i),
                      o = { body: n.body, source: n.source };
                  n.valid && (e.removeClass("failed").addClass("loading"), s(o, e));
              }
          },
          validateForm: function (t, e) {
              var s = t.find(".textarea-body"),
                  i = t.find(".input-source"),
                  n = e ? this.removeQuotationMarks(s.val().trim()) : this.ensureEndsInPeriod(this.removeQuotationMarks(s.val().trim()));
              return { valid: !!n, body: n, source: i.val().trim() };
          },
          removeQuotationMarks: function (t) {
              var e = [34, 39, 8216, 8217, 8220, 8221];
              return _.contains(e, t.charCodeAt(0)) && (t = t.slice(1)), _.contains(e, t.charCodeAt(t.length - 1)) && (t = t.slice(0, -1)), t;
          },
          ...
          textareaAutoexpandInitial: function (t) {
              var e = t.delegatedTarget,
                  s = e.value;
              (e.value = ""), (e.rows = 1), (e.baseScrollHeight = e.scrollHeight);
              var i = getComputedStyle(e);
              (e.baseContentHeight = e.baseScrollHeight - parseInt(i.paddingTop, 10) - parseInt(i.paddingBottom, 10)), (e.value = s), this.textareaAutoexpandLive(t);
          },
          textareaAutoexpandLive: function (t) {
              var e,
                  s = t.delegatedTarget;
              (s.rows = 1), (e = Math.ceil((s.scrollHeight - s.baseScrollHeight) / s.baseContentHeight)), (s.rows = 1 + e);
          },
      })),
      l.commandManager &&
          l.commandManager.registerCommand("settings.panels.quotes", function (t) {
              return new i.views.Main(t);
          }),
      i.styles.style(),
